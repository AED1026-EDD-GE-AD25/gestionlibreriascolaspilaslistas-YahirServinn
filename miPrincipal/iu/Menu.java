...
public class Menu{
    ...
    private static void imprimirMenu() throws PosicionIlegalException {
        ...
        do {
            ...
            System.out.println("8. Eliminar ultimo libro prestado (Corrección Préstamo)");
            System.out.println("9. Deshacer eliminacion de libro (Restaura operación)");
            ...
            try {
                switch (opcion) {
                    case 1: MenuOpciones.agregarLibro(); break;
                    case 2: MenuOpciones.mostrarLibros(); break;
                    case 3: MenuOpciones.agregarLibroCola(); break;
                    case 4: MenuOpciones.obtenerLibroCola(); break;
                    case 5: MenuOpciones.mostrarReservaLibros(); break;
                    case 6: MenuOpciones.crearPedido(); break;
                    case 7: MenuOpciones.devolverLibro(); break;
                    case 8: MenuOpciones.eliminarUltimoLibro(); break;
                    case 9: MenuOpciones.deshacerEliminarLibro(); break;
                    case 0: salir(); break;
